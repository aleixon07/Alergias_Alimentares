...
if (isset($_GET['id'])) {
    ...
    $sql1 = "SELECT * FROM usuario WHERE IdUsuario = '$id_adm'";
    $result1 = $conn->query($sql1);
    $row1 = $result1->fetch_assoc();

     $nivel_adm = $row1["Nivel"];
    ...
    if($nivel_adm < $nivel_delt){

        header("Location: ../adm/index.php?e=6512bd43d9caa6e02c990b0a82652dca");
        exit();
    }
