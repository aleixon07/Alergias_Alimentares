...
if (isset($_GET['id'])) {
    ...
    $sql2= "SELECT * FROM profissionais WHERE IdProfissional ='$del_id'";
    ...
    if (!empty($del_id)) {
        $sql = "DELETE FROM profissionais WHERE IdProfissional ='$del_id'";
        try {
        ...
        if($result){
            if($oculta == 1){
                header("Location: ../adm/index.php?e=17e62166fc8586dfa4d1bc0e1742c08b");
                exit();
            }
            if($oculta == 0){
