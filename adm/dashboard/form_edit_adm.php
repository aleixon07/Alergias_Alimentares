...
if (!isset($_GET["id"])) {
  header("Location: ../index.php?e=c81e728d9d4c2f636f067f89cc14862c");
  exit();
}
        ...
        <div class="sidebar_profile flex">
          <span class="nav_image">
            ...
            <?php if (isset($foto)) { ?>
              ...
              <img src="../../fotos/administradores/<?php echo $foto; ?>" alt="" />
  ...
  <main>
    ...
    <div class="section-1 mt-5">
      ...
      <div>
        ...
        <p class=' title-adm2 pb-3'>Local de listagem e gerenciamento de administradores.</p>
      </div>
      ...
      <div class='caixa__login_edit p-4 border-opacity-50 border border-black'>
        ...
        <form class='row' action='../../scripts/edit_user.php' method='POST' enctype='multipart/form-data'>
          ...
          <div class="col-5">
            <?php if (isset($foto2)) { ?>
              <img id="preview" height="200" src="../../fotos/administradores/<?php echo $foto2; ?>" alt="Foto Usuário" class="pb-2" style="border-radius: 30px; min-width: 200px; max-width: 300px;">
            <?php } else { ?>
