      ...
      <div class="menu_container">
        <div class="menu_items ">
          ...
          <ul class="menu_item p-0">
            ...
            <li class="item">
              <a href="../../views/perfil_receita.php?i=<?php echo $edit_id; ?>" class="link flex">
                <i class='bx bx-subdirectory-left'></i>
      ...
      <div class='caixa__login_edit p-4 border-opacity-50 border border-black'>
        ...
        <form class='row' action='../../scripts/edit_receita.php' method='POST' enctype='multipart/form-data'>
          ...
          <div class='col-5 pt-5'>
            ...
            <?php } ?> <br>
            <input class='form-control border-1 border-dark' type='file' accept='image/*' name='imagem' id='imagem' onchange='previewImagem(event)'>
          </div>

          <div class='row'>
            <div class='col-12 mb-4'>
              <label style='top: -10px; left: 0; color: #16a776; font-size: 13px;'>Ingredientes</label>
              <textarea name='ingrediente' id='ingrediente'><?php echo $ingredientes2; ?></textarea>
              <script>
          ...
          <div class='row'>
            <div class='col-12 mb-4'>
              ...
              <textarea name='modo_preparo' id='modo_preparo'><?php echo $modo_preparo2; ?></textarea>
              <script>
