...
if ($result->num_rows > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    $sql1 = "SELECT * FROM profissionais WHERE id_profissional ='$edit_id'";
  ...
  <main>
    ...
    <div class='section-1 mt-5'>
      ...
      <div class='caixa__login_edit p-4 border-opacity-50 border border-black'>
        ...
        <form class='row' action='../../scripts/edit_inscricao_prof.php' method='POST' enctype='multipart/form-data'>
          ...
          <div class='mt-3 row'>
            <div class='col-6'>
              ...
              <div class='caixa__login-input'>
                <input type='text' name='telefone' id='telefone' value='<?php echo $telefone2; ?>' />
            ...
            <div class='col-6'>
              <div class='caixa__login-input'>
                ...
                <label>Horário de Atendi mento</label>
              </div>
          ...
          <div class='row'>
            <div class='col-12'>
              <div class='caixa__login-input'>
                <input type='text' name='biografia' id='biografia' value='<?php echo $biografia2; ?>' />
