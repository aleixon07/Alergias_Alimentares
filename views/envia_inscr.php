    ...
    <main class="" style="padding-top: 90px;">
        ...
        <section class="mx-5 px-5 mb-4 content">
            ...
            <div class="border border-dark border-opacity-50 shadow-lg" style="border-radius: 20px;">
                <h3 class="text-center mt-3" style="color: <?php echo $cor_cabecalho;  ?>;">Envie Sua Inscrição
                </h3>
                <form action="../scripts/cad-prof.php" method="POST" enctype="multipart/form-data">
                    <div class="row mx-3">
                        <div class="col-8">
                            <div class="my-3">
                            ...
                            <div class="my-3">
                                ...
                                <input required type="text" name="email" class="border-bottom border-dark rounded w-100 ps-3" style="background-color: #ebebed;">
                            </div>
                            <div class="my-3">
                                <label for="" class="ms-3">Profissão</label>
                                <input required type="text" name="profissao" class="border-bottom border-dark rounded w-100 ps-3" style="background-color: #ebebed;">
                            </div>
                            <div class="my-3">
                                <label for="" class="ms-3">Hórario Atendimento</label>
                                <input required type="text" name="horario_atendimento" class="border-bottom border-dark rounded w-100 ps-3" style="background-color: #ebebed;">
                            </div>
                            <div class="my-3 row">
                                <div class="col">
                                    <label for="" class="ms-3">Preços</label>
                                    <input required type="text" name="preco" class="border-bottom border-dark rounded w-100 ps-3" style="background-color: #ebebed;">
                                </div>
                                <div class="col">
                                    <label for="" class="ms-3">Número de Telefone</label>
                                    <input required  type="text" name="telefone" class="border-bottom border-dark rounded w-100 ps-3" style="background-color: #ebebed;">
                                </div>
                        ...
                        <div class="col">
                            <img src="../fotos/usuarios/user.png" alt="Foto de fundo" style="border-radius: 25px; width: 330px; height:300px;" id="previe">
                        ...
                        <div class="col mb-3">
                            ...
                            <input required type="text" name="local_atendimento" id="addressInput" class="w-50 border-bottom border-dark rounded w-100 ps-3" style="background-color: #ebebed;">
...
<script>
    // Função para inicializar o mapa e realizar a pesquisa
    function initMap() {
        ...
        autocomplete.addListener('place_changed', () => {
            ...
            if (!place.geometry) {
                alert('Nenhum detalhe disponível para o endereço selecionado');
                return;
            }
...
<script async defer src='https://maps.googleapis.com/maps/api/js?key=AIzaSyCsJ7BiAuRUTKuXYG0G8yv48SA5g6FQEys&libraries=places&callback=initMap'></script>
